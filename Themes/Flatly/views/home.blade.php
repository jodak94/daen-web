...
@section('content')
  <main class="main-content">
          ...
          <div class="row">
            <div class="col-md-3 col-sm-6">
              <div class="feature">
                ...
                <img src="{{Theme::url('images/icon-research-small.png')}}" alt="" class="feature-image">
            ...
            <div class="col-md-3 col-sm-6">
              <div class="feature">
                <img src="{{Theme::url('images/icon-medicine-small.png')}}" alt="" class="feature-image">
            ...
            <div class="col-md-3 col-sm-6">
              <div class="feature">
                <img src="{{Theme::url('images/icon-genetics-small.png')}}" alt="" class="feature-image">
            ...
            <div class="col-md-3 col-sm-6">
              <div class="feature">
                <img src="{{Theme::url('images/icon-energy-small.png')}}" alt="" class="feature-image">
      ...
      <div class="fullwidth-block" data-bg-color="#edf2f4">
        <div class="container">
          ...
          <div class="row">
            <div class="col-md-4">
              <div class="post">
                <figure class="featured-image"><img src="{{Theme::url('images/news-1.jpg')}}" alt=""></figure>
            ...
            <div class="col-md-4">
              <div class="post">
                <figure class="featured-image"><img src="{{Theme::url('images/news-2.jpg')}}" alt=""></figure>
            ...
            <div class="col-md-4">
              <div class="post">
                <figure class="featured-image"><img src="{{Theme::url('images/news-3.jpg')}}" alt=""></figure>
      ...
      <div class="fullwidth-block cta" data-bg-image="{{Theme::url('images/cta-bg.jpg')}}">
        <div class="container">
